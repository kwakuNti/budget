...
try {
    ...
    $totalMonthlyIncome = floatval($incomeResult['total_monthly_income'] ?? 0);
    ...
    $categoriesByType = [
        ...
        'savings' => array_filter($categories, fn($cat) => $cat['category_type'] === 'savings')
    ];
    ...
    echo json_encode([
        ...
        'summary' => [
            ...
            'available_balance' => $totalMonthlyIncome - $totalPlanned,
